...
public class Manuscript{
    ...
    public void manuscript(String location, String repoInstitution, String type, String source, String name){
    ...
    public String getRepoInstitution(){return repoInstitution;}
